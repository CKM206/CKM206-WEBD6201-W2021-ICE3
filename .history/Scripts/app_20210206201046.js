    ...
    if (localStorage.length > 0) {
      ...
      for (let index = 0; index < localStorage.length; index++) {
        ...
        data += `<tr>
          ...
          <td class="content-center"><button class="btn btn-primary btn-sm"><i class="fas fa-edit fa-sm"> Edit</i></button></td>
          <td><button class="btn btn-danger btn-sm"><i class="fas fa-trash-alt fa-sm"> Delete</i></button></td>
        </tr>`;
      }
