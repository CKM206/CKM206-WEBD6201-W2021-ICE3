    ...
    if (localStorage.length > 0) {
      ...
      for (let index = 0; index < localStorage.length; index++) {
        ...
        data += `<tr>
          ...
          <td><button class="btn btn-primary fa-xs"><i class="fas fa-edit"> Edit</i></button></td>
          <td><button class="btn btn-danger fa-xs"><i class="fas fa-trash-alt"> Delete</i></button></td>
        </tr>`;
      }
