      ...
      for (let index = 0; index < localStorage.length; index++) {
        ...
        data += `<tr>
          ...
          <td class="text-center">
            <button data="${index + 1}" 
                    class="btn btn-primary btn-sm"><i class="fas fa-edit fa-sm edit"> Edit</i></button>
          </td>
          <td class="text-center">
            <button data="${index + 1}" 
                    class="btn btn-danger btn-sm"><i class="fas fa-trash-alt fa-sm delete"> Delete</i></button>
          </td>
        </tr>`;
      }
